...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func updateObstacles() {
        ...
        if spawnTimer >= 1.5 && randomizer == 0{
            
            /* Create a new obstacle reference object using our obstacle resource */
            let resourcePath = NSBundle.mainBundle().pathForResource("Obstacle2", ofType: "sks")
            let newObstacle = SKReferenceNode (URL: NSURL (fileURLWithPath: resourcePath!))
            obstacleLayer.addChild(newObstacle)
            
            /* Generate new obstacle position, start just outside screen and with a random y value */
            let randomPosition = CGPointMake(352, CGFloat.random(min: 290, max: 316))
        ...
        } else if spawnTimer >= 1.5 && randomizer == 1 {
            /* Create a new obstacle reference object using our obstacle resource */
        ...
        } else if spawnTimer >= 1.5 && randomizer == 2 {
            /* Create a new obstacle reference object using our obstacle resource */
            let resourcePath = NSBundle.mainBundle().pathForResource("Obstacle3", ofType: "sks")
            let newObstacle = SKReferenceNode (URL: NSURL (fileURLWithPath: resourcePath!))
            obstacleLayer.addChild(newObstacle)
    ...
    func didBeginContact(contact: SKPhysicsContact) {
        ...
        if nodeA.name == "goal" || nodeB.name == "goal" || nodeA.name == "goal2" || nodeB.name == "goal2" || nodeA.name == "goal3" || nodeB.name == "goal3" {
    ...
    func switchtoinfoscreen() {
        if let scene = infoScreen(fileNamed:"infoScreen") {
            // Configure the view.
            let skView = self.view as SKView!
